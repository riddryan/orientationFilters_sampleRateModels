classdef KF < AHRSfilter
    ...
    properties (Dependent)
        % 4x4 Gyroscope covariance matrix.
        %
        % Can be set:
        ...
        % 4x4 Accelerometer covariance matrix
        Sigma_a

        % 4x4 Magnetometer covariance matrix
        Sigma_m
...
%                 wz,wy,-wx,0];
    ...
    properties (Hidden)
        ...
        Sigma_g14(1,1) double = 0;
        Sigma_g24(1,1) double = 0;
        Sigma_g34(1,1) double = 0;
        Sigma_g44(1,1) double = 1;
        ...
        Sigma_a14(1,1) double = 0;
        Sigma_a24(1,1) double = 0;
        Sigma_a34(1,1) double = 0;
        Sigma_a44(1,1) double = 0.01;
        ...
        Sigma_m14(1,1) double = 0;
        Sigma_m24(1,1) double = 0;
        Sigma_m34(1,1) double = 0;
        Sigma_m44(1,1) double = 0.01;
    end
    ...
    methods
        ...
        function Sigma_g = get.Sigma_g(obj)
            ...
            if ~isempty(obj.Sigma_g_scalar)
                Sigma_g = eye(4)*obj.Sigma_g_scalar;
                return
            end
            Sigma_g = zeros(3);
            ...
            Sigma_g(1,4) = obj.Sigma_g14;
            Sigma_g(2,4) = obj.Sigma_g24;
            Sigma_g(3,4) = obj.Sigma_g34;
            Sigma_g(4,4) = obj.Sigma_g44;
            Sigma_g(4,1) = Sigma_g(1,4);
            Sigma_g(4,2) = Sigma_g(2,4);
            Sigma_g(4,3) = Sigma_g(3,4);
        end
        function Sigma_a = get.Sigma_a(obj)
            ...
            if ~isempty(obj.Sigma_a_scalar)
                Sigma_a = eye(4)*obj.Sigma_a_scalar;
                return
            end
            Sigma_a = zeros(3);
            ...
            Sigma_a(1,4) = obj.Sigma_a14;
            Sigma_a(2,4) = obj.Sigma_a24;
            Sigma_a(3,4) = obj.Sigma_a34;
            Sigma_a(4,4) = obj.Sigma_a44;
            Sigma_a(4,1) = Sigma_a(1,4);
            Sigma_a(4,2) = Sigma_a(2,4);
            Sigma_a(4,3) = Sigma_a(3,4);
        end
        function Sigma_m = get.Sigma_m(obj)
            ...
            if ~isempty(obj.Sigma_m_scalar)
                Sigma_m = eye(4)*obj.Sigma_m_scalar;
                return
            end
            Sigma_m = zeros(3);
            ...
            Sigma_m(1,4) = obj.Sigma_m14;
            Sigma_m(2,4) = obj.Sigma_m24;
            Sigma_m(3,4) = obj.Sigma_m34;
            Sigma_m(4,4) = obj.Sigma_m44;
            Sigma_m(4,1) = Sigma_m(1,4);
            Sigma_m(4,2) = Sigma_m(2,4);
            Sigma_m(4,3) = Sigma_m(3,4);
        end
        function set.Sigma_g(obj,I)
            if isdiag(I) && I(1,1)==I(2,2) && I(1,1)==I(3,3) && I(1,1)==I(4,4)
